...
export const REGISTER_THEME_SCHEMA = {
    name: "register_theme",
    description: "Register a custom theme compatible with the 'create_draft' tool to save a draft to '微信公众号草稿箱'.",
    inputSchema: {
        type: "object",
        properties: {
            name: {
...
export const REMOVE_THEME_SCHEMA = {
    name: "remove_theme",
    description: "Remove a custom theme compatible with the 'create_draft' tool to save a draft to '微信公众号草稿箱'.",
    inputSchema: {
        type: "object",
        properties: {
            name: {
